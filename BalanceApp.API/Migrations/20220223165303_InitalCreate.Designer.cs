...
namespace BalanceApp.API.Migrations
{
    ...
    [Migration("20220223165303_InitalCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BalanceApp.API.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BalanceApp.API.ValueObjects.Balance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BalanceApp.API.ValueObjects.BodyData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BalanceApp.API.ValueObjects.Balance", b =>
                {
                    b.HasOne("BalanceApp.API.Entities.User", null)
                        .WithMany("Balances")
